...
export default defineConfig({
  ...
  metadata: {
    atlasFreshPort: 3063,
    soakEvidenceVersion: "v216-production-lifecycle-soak",
    soakEvidenceOutput: "dist/science/lifecycle-soak-v216-report.json",
    soakRuntimeBaseline: "next16-react19-r3f9-standalone-production-v216",
  },
  projects: [{
  ...
  webServer: {
    command: "node scripts/start-atlas-standalone.mjs --dist-dir .next-v216 --port 3063",
