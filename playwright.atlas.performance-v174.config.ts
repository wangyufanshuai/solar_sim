...
export default defineConfig({
  ...
  metadata: {
    atlasFreshPort: 3021,
    performanceEvidenceVersion: "v174-hardware-performance-production",
    performanceEvidenceOutput: "dist/science/performance-v174-report.json",
    performanceRuntimeBaseline: "next15-react19-r3f9-standalone-production-v174",
  },
  projects: [{
  ...
  webServer: {
    command: "node scripts/start-atlas-standalone.mjs --dist-dir .next-v174 --port 3021",
