...
process.env.ATLAS_BUNDLE_EVIDENCE_VERSION = "v216";

const baseURL = "http://127.0.0.1:3059";
export default defineConfig({
  ...
  webServer: {
    command: "node scripts/start-atlas-standalone.mjs --dist-dir .next-v216-lite --port 3059",
