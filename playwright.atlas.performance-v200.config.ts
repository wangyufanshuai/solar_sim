...
export default defineConfig({
  ...
  metadata: {
    atlasFreshPort: 3053,
    performanceEvidenceVersion: "v200-hardware-performance-production",
    performanceEvidenceOutput: "dist/science/performance-v200-report.json",
    performanceRuntimeBaseline: "next16-react19-r3f9-standalone-production-v200",
  },
  projects: [{
  ...
  webServer: {
    command: "node scripts/start-atlas-standalone.mjs --dist-dir .next-v200 --port 3053",
