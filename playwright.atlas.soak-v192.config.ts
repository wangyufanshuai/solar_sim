...
const baseURL = "http://127.0.0.1:3043";
...
export default defineConfig({
  ...
  metadata: {
    atlasFreshPort: 3043,
    soakEvidenceVersion: "v192-production-lifecycle-soak",
    soakEvidenceOutput: "dist/science/lifecycle-soak-v192-report.json",
    soakRuntimeBaseline: "next16-react19-r3f9-standalone-production-v192",
  },
  projects: [{
  ...
  webServer: {
    command: "node scripts/start-atlas-standalone.mjs --dist-dir .next-v192 --port 3043",
