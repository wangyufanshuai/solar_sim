...
import type { MissionInspectionSelection, MissionPlan } from "../lib/missionDesignerTypes";
      ...
      <BloomSceneProvider>
        ...
        {simulation.viewSettings.showMissionTrajectory ? (
          <MissionTrajectoryPreview
            ...
            inspectionSelection={simulation.missionInspectionSelection ?? null}
          />
        ) : null}
        <CloseupPresentationGate activeRef={closeupPresentationRef}>
