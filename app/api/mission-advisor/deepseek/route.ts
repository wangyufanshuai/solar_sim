        ...
        messages: [
          ...
          },
          {
            ...
            content: JSON.stringify({
              instruction:
                "Explain this Earth-Venus-Jupiter-Saturn mission candidate in concise engineering language. Emphasize delta-v, flyby risk, communications delay, attitude/navigation concerns, and practical next steps.",
