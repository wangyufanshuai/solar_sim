...
export const LAUNCH_MISSION_PROFILES: LaunchMissionProfile[] = [
  ...
  },
  {
    ...
    shortName: "LEO Satellite",
    description: "Single Earth-observation satellite insertion using the existing local launch and spacecraft handoff path.",
    missionMode: "leo",
    destination: "LEO",
    vehicle: "Reusable medium-lift launch vehicle",
    payloadName: "Earth observation satellite",
    defaultSite: "cape_canaveral",
    targetAltitudeM: 550_000,
    defaultTimeScale: 4,
    cargoMassKg: 1_200,
    targetInclinationDeg: 53,
    objectives: ["Clean ascent", "Parking orbit insertion", "Payload separation", "Satellite handoff"],
    timeline: [
      { label: "Booster separation", timeS: 155 },
      { label: "Second-stage cutoff", timeS: 510 },
      { label: "Orbit insertion", timeS: 690 },
      { label: "Satellite deployment", timeS: 900 },
    ],
  },
  {
    id: "leo_validation",
