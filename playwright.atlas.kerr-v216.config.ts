...
export default defineConfig({
  ...
  workers: 1,
  projects: [
    { name: "desktop-kerr-v216", use: { viewport: { width: 1440, height: 900 } } },
    { name: "mobile-kerr-v216", use: { viewport: { width: 390, height: 844 } } },
  ],
  use: { ...(typeof baseConfig.use === "object" ? baseConfig.use : {}), baseURL },
  webServer: {
    command: "node scripts/start-atlas-standalone.mjs --dist-dir .next-v216 --port 3062",
